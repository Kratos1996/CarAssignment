...
class ModifiedAdapter(var myVisitingPlaceList: List<UserDefinedData>) :
    RecyclerView.Adapter<ModifiedAdapter.myViewHolder>() {
    ...
    private fun callMyVisitedCarList(
        ...
        val intent = Intent(holder.itemView.context, UpdateDetails::class.java)
        intent.apply {
